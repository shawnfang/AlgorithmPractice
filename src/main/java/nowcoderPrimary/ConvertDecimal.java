...
public class ConvertDecimal {
    public static void main(String[] args) {
        int a = 1234;
        String strHex = Integer.toHexString(a).toUpperCase();
        System.out.println("0X"+strHex);
        String strOct = Integer.toOctalString(a);
        System.out.println("0"+strOct);
        String strBinary = Integer.toBinaryString(a);
